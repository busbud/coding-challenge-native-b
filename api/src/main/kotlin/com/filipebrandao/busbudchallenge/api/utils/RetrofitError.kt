...
class RetrofitError(rawResponse: Response<*>?, throwable: Throwable) : KoinComponent {
    ...
    private fun getErrorType(throwable: Throwable, statusCode: Int): ErrorType {
        return getErrorTypeBasedOnStatusCode(statusCode) ?: getErrorTypeBasedOnThrowable(statusCode, throwable) ?: ErrorType.GENERAL
    }
    ...
    fun isBadRequest(): Boolean {
        return statusCode == BAD_REQUEST_ERROR
    }

    fun isUnauthorized(): Boolean {
        return statusCode == NOT_AUTHORIZED_ERROR
    }
}
