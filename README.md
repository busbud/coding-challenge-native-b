...
It's getting cold in Montréal and the Igloofest will take place very soon (http://igloofest.ca/en/). 
The challenge is to build a promotional app that allows a user from NYC to look for one-way trip schedules to come for the opening night of the festival.
